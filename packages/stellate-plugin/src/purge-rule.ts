...
import { MajelEvent, Injector } from '@majel/core'
 ...
 * @docsPage PurgeRule
 */
export interface PurgeRuleConfig<Event extends MajelEvent> {
	/**
	 * @description
	 * Specifies which MajelEvent will trigger this purge rule.
	 */
...
/**
 * @description
 * Defines a rule that listens for a particular MajelEvent and uses that to
 ...
 * @docsWeight 0
 */
export class PurgeRule<Event extends MajelEvent = MajelEvent> {
