import { LanguageCode, LogicalOperator, PriceRange, SortOrder } from '@majel/common/lib/generated-types'
import { DeepRequired, ID, UserInputError } from '@majel/core'
...
export function buildElasticBody(
	...
	const scriptFields: any | undefined = createScriptFields(searchConfig.scriptFields, input, groupByProduct)
