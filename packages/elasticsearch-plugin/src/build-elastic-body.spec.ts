import { LanguageCode, LogicalOperator, SortOrder } from '@majel/common/lib/generated-types'
import { DeepRequired } from '@majel/core'
...
describe('buildElasticBody()', () => {
	...
	it('collectionSlug', () => {
		const result = buildElasticBody({ collectionSlug: 'plants' }, searchConfig, CHANNEL_ID, LanguageCode.en)
		expect(result.query).toEqual({
			bool: {
