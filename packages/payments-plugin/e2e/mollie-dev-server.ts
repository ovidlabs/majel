...
import { DefaultLogger, DefaultSearchPlugin, LogLevel, mergeConfig } from '@majel/core'
import { createTestEnvironment, registerInitializer, SqljsInitializer, testConfig } from '@majel/testing'
...
async function runMollieDevServer() {
	...
	const config = mergeConfig(testConfig, {
		plugins: [
			...
			MolliePlugin.init({ majelHost: tunnel.url }),
		],
