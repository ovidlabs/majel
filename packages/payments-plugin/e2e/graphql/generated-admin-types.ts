 ...
 * Majel server. The `code` property is typically a 2-character ISO code such as "GB", "US", "DE" etc.
...
export type MolliePaymentIntentInput = {
	...
	/**
	 * The code of the Majel payment method to use for the payment.
 ...
 *
 * `Permission.Owner` is a special permission which is used in some Majel resolvers to indicate that that resolver should only
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'PaymentMethod' } }],
						},
					},
				],
			},
							...
							selections: [
								{
									...
									selectionSet: {
										kind: 'SelectionSet',
										selections: [{ kind: 'Field', name: { kind: 'Name', value: 'errorCode' } }],
									},
								},
