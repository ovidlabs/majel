...
import { CurrencyCode, Customer, Order } from '@majel/core'
 ...
 * Majel calculates tax per unit, but Mollie expects the tax to be calculated per order line (the total of the quantities).
 * See https://github.com/majel-ecommerce/majel/issues/1939#issuecomment-1362962133 for more information on the rounding issue.
 */
