...
import { DeletionResponse, DeletionResult, LanguageCode } from '@majel/common/lib/generated-types'
import { CustomFieldsObject, ID, PaginatedList } from '@majel/common/lib/shared-types'
import {
	assertFound,
...
class TemplateEntity extends MajelEntity implements Translatable, HasCustomFields {
	constructor() {
		super()
	}
...
class TemplateEntityTranslation extends MajelEntity implements Translation<TemplateEntity> {
	constructor() {
		super()
	}
