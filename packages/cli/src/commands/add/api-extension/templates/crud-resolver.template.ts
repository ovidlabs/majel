...
import { DeletionResponse, Permission } from '@majel/common/lib/generated-types'
import { CustomFieldsObject } from '@majel/common/lib/shared-types'
import {
	Allow,
	Ctx,
	PaginatedList,
...
class TemplateEntity extends MajelEntity {
	constructor() {
		super()
	}
}
