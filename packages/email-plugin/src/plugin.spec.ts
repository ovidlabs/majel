...
import { ensureConfigLoaded } from '@majel/core/dist/config/config-helpers'
...
describe('EmailPlugin', () => {
	...
	describe('templateVars', () => {
		 ...
		 * See https://github.com/majel-ecommerce/majel/issues/259
		 */
		...
		// Test fix for https://github.com/majel-ecommerce/majel/issues/363
...
class MockEvent extends MajelEvent {
	constructor(
