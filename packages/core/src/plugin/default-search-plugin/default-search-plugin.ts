...
import { SearchReindexResponse } from '@majel/common/lib/generated-types'
 ...
 * underlying database.
 *
 * The DefaultSearchPlugin is bundled with the `\@majel/core` package. If you are not using an alternative search
 ...
 * @example
 * ```ts
 * import { DefaultSearchPlugin, MajelConfig } from '\@majel/core';
 *
