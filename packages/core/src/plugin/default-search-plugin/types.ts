import { SearchInput as GeneratedSearchInput } from '@majel/common/lib/generated-types'
import { ID, JsonCompatible } from '@majel/common/lib/shared-types'
...
export interface DefaultSearchPluginInitOptions {
	 ...
	 * Majel installation will require a DB migration/synchronization.
	 *
	 * @default false.
	 */
