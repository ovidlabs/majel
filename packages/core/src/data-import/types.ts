import { ConfigurableOperationInput, LanguageCode, Permission } from '@majel/common/lib/generated-types'
...
/**
 * @description
 * An object defining initial settings for a new Majel installation.
 *
