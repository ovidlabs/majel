...
/**
 * @description
 * A User represents any authenticated user of the Majel API. This includes both
 * {@link Administrator}s as well as registered {@link Customer}s.
 *
 * @docsCategory entities
 */
@Entity()
export class User extends MajelEntity implements HasCustomFields, SoftDeletable {
