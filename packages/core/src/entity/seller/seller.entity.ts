 ...
 * By default, a single-channel Majel installation will have a single default Seller.
 *
 * @docsCategory entities
 */
@Entity()
export class Seller extends MajelEntity implements SoftDeletable, HasCustomFields {
