import { ConfigurableOperation } from '@majel/common/lib/generated-types'
 ...
 */
@Entity()
export class PaymentMethod extends MajelEntity implements Translatable, ChannelAware, HasCustomFields {
