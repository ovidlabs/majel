...
export class LocaleStringHydrator {
	...
	async hydrateLocaleStringField<T extends MajelEntity & Translatable & { languageCode?: LanguageCode }>(
		ctx: RequestContext,
		entity: T,
	 ...
	 */
	private async hydrateLocaleStrings<T extends MajelEntity & Translatable>(
		ctx: RequestContext,
		entity: T,
