...
describe('translateDeep()', () => {
	interface TestProduct extends MajelEntity {
		singleTestVariant: TestVariant
		singleRealVariant: ProductVariant
	}

	class TestProductEntity extends MajelEntity implements Translatable {
		constructor() {
			super()
		}
		id: string
	...
	interface TestVariant extends MajelEntity {
		singleOption: ProductOption
	}

	class TestVariantEntity extends MajelEntity implements Translatable {
		constructor() {
			super()
		}
		id: string
