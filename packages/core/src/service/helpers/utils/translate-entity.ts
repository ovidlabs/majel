 ...
 */
export function translateEntity<T extends Translatable & MajelEntity>(
	translatable: T,
	languageCode: LanguageCode | [LanguageCode, ...LanguageCode[]],
): Translated<T> {
	let translation: Translation<MajelEntity> | undefined
 ...
 */
export function translateDeep<T extends Translatable & MajelEntity>(
	translatable: T,
	languageCode: LanguageCode | [LanguageCode, ...LanguageCode[]],
...
export type TreeNode = { children: TreeNode[] } & Translatable & MajelEntity
