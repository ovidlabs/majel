...
import { UpdateCustomerInput as UpdateCustomerShopInput } from '@majel/common/lib/generated-shop-types'
import {
 ...
 *
 * Since Majel v1.9.0, it is possible to define custom HistoryEntry types.
 *
 ...
 * import { Injectable } from '\@nestjs/common';
 * import { RequestContext } from '\@majel/core';
