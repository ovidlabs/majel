 ...
 *
 * Creating a CollectionFilter is considered an advanced Majel topic. For more insight into how
 * they work, study the [default collection filters](https://github.com/majel-ecommerce/majel/blob/master/packages/core/src/config/catalog/default-collection-filters.ts)
 *
 * Here's a simple example of a custom CollectionFilter:
 *
 * @example
 * ```ts
 * import { CollectionFilter, LanguageCode } from '\@majel/core';
 *
