import { ConfigArg, RefundOrderInput } from '@majel/common/lib/generated-types'
...
export interface PaymentMethodConfigOptions<T extends ConfigArgs> extends ConfigurableOperationDefOptions<T> {
	 ...
	 * if it gets cancelled via Majel.
	 *
	 * @since 1.7.0
	 */
 ...
 * @example
 * ```ts
 * import { PaymentMethodHandler, CreatePaymentResult, SettlePaymentResult, LanguageCode } from '\@majel/core';
