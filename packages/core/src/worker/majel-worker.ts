...
export class MajelWorker {
	 ...
	 */
	async startJobQueue(): Promise<MajelWorker> {
	 ...
	 * @since 1.2.0
	 */
	async startHealthCheckServer(healthCheckConfig: WorkerHealthCheckConfig): Promise<MajelWorker> {
