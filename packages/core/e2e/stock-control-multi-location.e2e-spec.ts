...
import { manualFulfillmentHandler, mergeConfig } from '@majel/core'
...
describe('Stock control', () => {
	...
	it('default StockLocation exists', async () => {
		const { stockLocations } = await adminClient.query<Codegen.GetStockLocationsQuery>(GET_STOCK_LOCATIONS)
