...
describe('ListQueryBuilder', () => {
	...
	describe('multiple clauses', () => {
		it('sort by translated field en & filter', async () => {
			...
			expect(testEntities.items.map((x: any) => x.name)).toEqual(['baum', 'bike', 'cake', 'dog', 'egg'])
		})
	...
	// https://github.com/majel-ecommerce/majel/issues/1586
	...
	// https://github.com/majel-ecommerce/majel/issues/1611
