...
describe('Payment process', () => {
	...
	const paymentGuard: ErrorResultGuard<Codegen.PaymentFragment> = createErrorResultGuard(input => !!input.id)
	...
	describe('failing, cancelling, and manually adding a Payment', () => {
		...
		beforeAll(async () => {
			...
			await adminClient.query<Codegen.AdminTransitionMutation, Codegen.AdminTransitionMutationVariables>(
				ADMIN_TRANSITION_TO_STATE,
				{
					id: order2Id,
					state: 'ValidatingPayment',
