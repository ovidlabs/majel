...
describe('ChannelAware Products and ProductVariants', () => {
	...
	describe('assigning Product to Channels', () => {
		...
		// https://github.com/majel-ecommerce/majel/issues/2716
	...
	describe('updating channel defaultCurrencyCode', () => {
		...
		it('updates variant prices from old default to new', async () => {
			...
			const { productVariants: variantsAfter } = await adminClient.query(GetProductVariantListDocument, {})
		...
		// https://github.com/majel-ecommerce/majel/issues/2391
