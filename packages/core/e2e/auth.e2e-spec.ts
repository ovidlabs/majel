...
import { SUPER_ADMIN_USER_IDENTIFIER, SUPER_ADMIN_USER_PASSWORD } from '@majel/common/lib/shared-constants'
...
describe('Authorization & permissions', () => {
	...
	describe('admin permissions', () => {
		...
		describe('ReadCatalog permission', () => {
			...
			it('me returns correct permissions', async () => {
				...
				expect(me!.channels[0].permissions).toEqual([Permission.Authenticated, Permission.ReadCatalog])
			})
	...
	describe('protected field resolvers', () => {
		...
		beforeAll(async () => {
			...
			readCatalogAdmin = await createAdministratorWithPermissions('ReadCatalog', [Permission.ReadCatalog])
		})
		...
		// https://github.com/majel-ecommerce/majel/issues/730
