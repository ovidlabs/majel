...
import { ROOT_COLLECTION_NAME } from '@majel/common/lib/shared-constants'
import {
...
describe('Collection resolver', () => {
	...
	/**
	 * Test case for https://github.com/majel-ecommerce/majel/issues/97
	 */
		...
		it('creates a 2nd level nested collection', async () => {
			...
			>(CREATE_COLLECTION, {
				input: {
					...
					translations: [{ languageCode: LanguageCode.en, name: 'Pear', description: '', slug: 'pear' }],
					filters: [
						{
							code: facetValueCollectionFilter.code,
							arguments: [
	...
	describe('querying', () => {
		...
		// Tests fix for https://github.com/majel-ecommerce/majel/issues/361
		...
		// https://github.com/majel-ecommerce/majel/issues/981
		...
		// https://github.com/majel-ecommerce/majel/issues/642
	...
	describe('moveCollection', () => {
		...
		it(
			...
			assertThrowsWithMessage(
				() =>
					adminClient.query<Codegen.MoveCollectionMutation, Codegen.MoveCollectionMutationVariables>(
						MOVE_COLLECTION,
						{
							input: {
								collectionId: pearCollection.id,
		...
		// https://github.com/majel-ecommerce/majel/issues/1595
	...
	describe('filters', () => {
						...
						filters: [
							{
								...
								arguments: [
									{
										name: 'facetValueIds',
										value: `["${getFacetValueId('pear')}", "${getFacetValueId('photo')}"]`,
									},
									{
										name: 'containsAny',
										value: 'false',
		...
		describe('variantName filter', () => {
			...
			// https://github.com/majel-ecommerce/majel/issues/927
						...
						filters: [
							{
								...
								arguments: [
									{
										name: 'facetValueIds',
										value: `["${getFacetValueId('electronics')}","${getFacetValueId('pear')}"]`,
									},
									{
										name: 'containsAny',
										value: 'false',
	...
	describe('productVariants list', () => {
		...
		// https://github.com/majel-ecommerce/majel/issues/1213
