...
export class TestAdminPluginResolver {
	...
	// Test case for https://github.com/majel-ecommerce/majel/issues/1153
	@Query()
	...
	// Test case for https://github.com/majel-ecommerce/majel/issues/1161
	@Query()
	...
	// Test case for https://github.com/majel-ecommerce/majel/issues/1324
	@Query()
	...
	// Test case for https://github.com/majel-ecommerce/majel/issues/1172
	@Query()
	...
	// Test case for https://github.com/majel-ecommerce/majel/issues/1229
	@Query()
	...
	// Test case for https://github.com/majel-ecommerce/majel/issues/1284
	@Query()
...
@Entity()
export class AdditionalConfig extends MajelEntity {
