...
@Entity()
export class CustomFieldRelationTestEntity extends MajelEntity {
...
@Entity()
export class CustomFieldOtherRelationTestEntity extends MajelEntity {
...
@Entity()
export class TestEntity extends MajelEntity implements Translatable, HasCustomFields {
...
@Entity()
export class TestEntityTranslation extends MajelEntity implements Translation<TestEntity> {
...
@Entity()
export class TestEntityPrice extends MajelEntity {
