...
@Entity()
export class Vendor extends MajelEntity {
	constructor() {
		super()
	}
...
/**
 * Testing https://github.com/majel-ecommerce/majel/issues/1636
 *
 * and
 *
	...
	configuration: config => {
		config.customFields.Product.push(
			...
			},
			{
				...
				// https://github.com/majel-ecommerce/majel/issues/1664#issuecomment-1293916504
