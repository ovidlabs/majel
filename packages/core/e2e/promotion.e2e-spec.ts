...
import { PromotionAction, PromotionCondition, PromotionOrderAction } from '@majel/core'
import {
	...
	describe('deletion', () => {
		...
		it(
			...
			assertThrowsWithMessage(
				() =>
					adminClient.query<Codegen.UpdatePromotionMutation, Codegen.UpdatePromotionMutationVariables>(
						UPDATE_PROMOTION,
						{
							input: {
								id: promotionToDelete.id,
