...
import { DefaultJobQueuePlugin, DefaultSearchPlugin, mergeConfig } from '@majel/core'
import { createTestEnvironment, registerInitializer, SqljsInitializer } from '@majel/testing'
...
import { SearchProductsShopQuery, SearchProductsShopQueryVariables } from './graphql/generated-e2e-shop-types'
