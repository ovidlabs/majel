import { DefaultMoneyStrategy, Logger, mergeConfig, MoneyStrategy, MajelPlugin } from '@majel/core'
...
describe('Custom MoneyStrategy', () => {
	...
	// https://github.com/majel-ecommerce/majel/issues/838
	...
	// https://github.com/majel-ecommerce/majel/issues/1835
	// 31 * 1.2 = 37.2
