		...
		console.error(
			pc.red(
				'You are running Node %s.\n' +
					'Majel requires Node %s or higher. \n' +
...
export function getDependencies(
	...
	const dependencies = [
		`@majel/core${majelPkgVersion}`,
		`@majel/email-plugin${majelPkgVersion}`,
		`@majel/asset-server-plugin${majelPkgVersion}`,
		`@majel/admin-ui-plugin${majelPkgVersion}`,
		'dotenv',
		dbDriverPackage(dbType),
	]
	const devDependencies = [
		`@majel/cli${majelPkgVersion}`,
		'concurrently',
...
function throwConnectionError(err: any) {
	throw new Error(
		'Could not connect to the database. ' +
			`Please check the connection settings in your Majel config.\n[${
