...
export interface AdminUiExtension
	 ...
	 * [Extending the Admin UI](https://www.majel.io/docs/plugins/extending-the-admin-ui/) but having `paths`
	 ...
	 * import { SharedModule } from '\@majel/admin-ui/core';
	 ...
	 *
	 * import { AdminUiExtension } from '\@majel/ui-devkit/compiler';
	 *
