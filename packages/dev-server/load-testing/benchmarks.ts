...
import { GlobalFlag } from '@majel/common/lib/generated-types'
import {
	bootstrap,
	Importer,
...
import { ParsedProductWithVariants } from '@majel/core/src/index'
import { clearAllTables } from '@majel/testing'
 ...
 * in issue https://github.com/majel-ecommerce/majel/issues/1506.
 *
...
const DATABASE_NAME = 'majel-benchmarks'
