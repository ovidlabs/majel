...
import { bootstrap, JobQueueService, Logger } from '@majel/core'
import { populate } from '@majel/core/cli/populate'
import { clearAllTables, populateCustomers, SimpleGraphQLClient } from '@majel/testing'
...
if (require.main === module) {
	...
	const databaseName = `majel-load-testing-${count}`
...
/**
 * Generates a CSV file of test product data which can then be imported into Majel.
 */
