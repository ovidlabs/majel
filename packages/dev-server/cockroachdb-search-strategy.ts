import { LogicalOperator, SearchInput, SearchResult } from '@majel/common/lib/generated-types'
...
import { SearchIndexItem } from '@majel/core/dist/plugin/default-search-plugin/entities/search-index-item.entity'
import { SearchStrategy } from '@majel/core/dist/plugin/default-search-plugin/search-strategy/search-strategy'
import { getFieldsToSelect } from '@majel/core/dist/plugin/default-search-plugin/search-strategy/search-strategy-common'
import {
	...
	mapToSearchResult,
} from '@majel/core/dist/plugin/default-search-plugin/search-strategy/search-strategy-utils'
import { DefaultSearchPluginInitOptions } from '@majel/core/dist/plugin/default-search-plugin/types'
