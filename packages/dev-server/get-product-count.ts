import { bootstrapWorker, Logger, ProductService, RequestContextService } from '@majel/core'
...
async function getProductCount() {
	// This will bootstrap an instance of the Majel Worker, providing
	// us access to all of the services defined in the Majel core.
	const { app } = await bootstrapWorker(devConfig)

	// Using `app.get()` we can grab an instance of _any_ provider defined in the
	// Majel core as well as by our plugins.
