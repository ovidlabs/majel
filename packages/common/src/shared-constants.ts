...
export const DEFAULT_AUTH_TOKEN_HEADER_KEY = 'majel-auth-token'
export const DEFAULT_COOKIE_NAME = 'session'
export const DEFAULT_CHANNEL_TOKEN_KEY = 'majel-token'

// An environment variable which is set when the @majel/create
// script is run. Can be used to modify normal behaviour
// to fit with the initial create task.
export type CREATING_MAJEL_APP = 'CREATING_MAJEL_APP'
export const CREATING_MAJEL_APP: CREATING_MAJEL_APP = 'CREATING_MAJEL_APP'
