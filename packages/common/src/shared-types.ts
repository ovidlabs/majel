...
/**
 * @description
 * A type describing the shape of a paginated list response. In Majel, almost all list queries
...
/**
 * @description
 * This interface describes JSON config file (majel-ui-config.json) used by the Admin UI.
...
export interface AdminUiConfig {
	/**
	 * @description
	 * The hostname of the Majel server which the admin UI will be making API calls
	...
	/**
	 * @description
	 * The port of the Majel server which the admin UI will be making API calls
	...
	/**
	 * @description
	 * Option to hide majel branding.
	 *
	 * @default false
	 */
	hideMajelBranding?: boolean
	/**
	 * @description
	...
	/**
	 * @description
	 * A url of a custom image to be used on the login screen, to override the images provided by Majel's login image server.
	 *
	 * @since 1.9.0
	 */
...
export interface AdminUiAppConfig {
	 ...
	 * default build is used. This path should contain the `majel-ui-config.json` file,
...
export interface AdminUiAppDevModeConfig {
	/**
	 * @description
	 * The path to the uncompiled UI app source files. This path should contain the `majel-ui-config.json` file.
	 */
	sourcePath: string
	/**
	 * @description
