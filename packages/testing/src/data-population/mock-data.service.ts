import { CreateAddressInput, CreateCustomerInput } from '@majel/common/lib/generated-types'
...
export class MockDataService {
	...
	static getCustomers(count: number): Array<{ customer: CreateCustomerInput; address: CreateAddressInput }> {
		faker.seed(1)
