...
import { importProductsFromCsv, populateCollections, populateInitialData } from '@majel/core/cli'
...
export async function populateForTesting<T extends INestApplicationContext>(
	config: Required<MajelConfig>,
	bootstrapFn: (config: MajelConfig) => Promise<T>,
