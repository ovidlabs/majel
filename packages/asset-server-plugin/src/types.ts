import { AssetNamingStrategy, AssetPreviewStrategy, AssetStorageStrategy, RequestContext } from '@majel/core'
...
export interface AssetServerOptions {
	...
	/**
	 * @description
	 * The complete URL prefix of the asset files. For example, "https://demo.majel.io/assets/". A
