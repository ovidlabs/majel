...
import { CUSTOMER_ROLE_CODE } from '@majel/common/lib/shared-constants'
	...
	implements OnInit, OnDestroy
{
	...
	detailForm = this.formBuilder.group({
		...
		password: [''],
		roles: [
			[] as NonNullable<ResultOf<typeof GetAdministratorDetailDocument>['administrator']>['user']['roles'],
		],
