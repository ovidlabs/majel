...
describe('TimeAgoPipe', () => {
	...
	it('minutes ago', () => {
		...
		expect(mockI18nService.translate.calls.argsFor(0)).toEqual(['datetime.ago-minutes', { count: 2 }], 'a')

		pipe.transform('2020-02-04T16:12:10.500Z', '2020-02-04T16:15:10.500Z')
		expect(mockI18nService.translate.calls.argsFor(1)).toEqual(['datetime.ago-minutes', { count: 3 }], 'b')

		pipe.transform('2020-02-04T15:20:10.500Z', '2020-02-04T16:15:10.500Z')
		expect(mockI18nService.translate.calls.argsFor(2)).toEqual(['datetime.ago-minutes', { count: 55 }], 'c')
	})
