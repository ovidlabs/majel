...
export class ProductDataService {
	...
	createAssets(files: File[]) {
		return this.baseDataService.mutate<Codegen.CreateAssetsMutation, Codegen.CreateAssetsMutationVariables>(
			CREATE_ASSETS,
			{
	...
	deleteAssets(ids: string[], force: boolean) {
		return this.baseDataService.mutate<Codegen.DeleteAssetsMutation, Codegen.DeleteAssetsMutationVariables>(
			DELETE_ASSETS,
			{
				input: {
					assetIds: ids,
