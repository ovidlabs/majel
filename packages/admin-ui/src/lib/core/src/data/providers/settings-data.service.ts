...
export class SettingsDataService {
	...
	createSeller(input: Codegen.CreateSellerInput) {
		return this.baseDataService.mutate<Codegen.CreateSellerMutation, Codegen.CreateSellerMutationVariables>(
			CREATE_SELLER,
			{
				input,
			},
	...
	updateSeller(input: Codegen.UpdateSellerInput) {
		return this.baseDataService.mutate<Codegen.UpdateSellerMutation, Codegen.UpdateSellerMutationVariables>(
			UPDATE_SELLER,
			{
				input,
			},
	...
	deleteSeller(id: string) {
		return this.baseDataService.mutate<Codegen.DeleteSellerMutation, Codegen.DeleteSellerMutationVariables>(
			DELETE_SELLER,
			{
				id,
			},
	...
	updatePaymentMethod(input: Codegen.UpdatePaymentMethodInput) {
		...
		>(UPDATE_PAYMENT_METHOD, {
			input: pick(input, ['id', 'code', 'checker', 'handler', 'enabled', 'translations', 'customFields']),
		})
	}
