...
/**
 * For some unknown reason, a v1.2.2 of @majel/core included incorrect type definitions for some types.
 ...
 *
 * Example:
 * [dummy-payment-method-handler.d.ts](https://unpkg.com/@majel/core@1.2.2/dist/config/payment/dummy-payment-method-handler.d.ts)
 * ```
