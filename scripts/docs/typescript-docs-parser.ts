...
export class TypescriptDocsParser {
     ...
     * when a plugin includes in its description some text like "install the @majel/some-plugin package". Here,
     * TypeScript will interpret "@majel" as a JSDoc tag and remove it and all remaining text from the comment.
     *
